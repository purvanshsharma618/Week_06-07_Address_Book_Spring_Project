...
public class AddressBookController {
    ...
    @PostMapping("/create")
    public ResponseEntity<AddressBook> addAddressBook(@Valid @RequestBody AddressBook newBook) {
    ...
    public ResponseEntity<?> updateAddressBook(@PathVariable Long id, @Valid @RequestBody AddressBook updatedBook) {
